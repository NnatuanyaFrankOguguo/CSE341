...
console.log('🚀 Starting Digital Library Management System (JWT Version)...');
  ...
  res.json({ 
    ...
    endpoints: {
      ...
      authors: {
        ...
        'PUT /api/authors/:id': 'Update author (requires JWT auth)',
        'DELETE /api/authors/:id': 'Delete author (requires JWT auth)',
        'POST /api/authors/:id/awards': 'Add award to author (requires JWT auth)'
      }
    },
    features: [
      'GitHub OAuth authentication',
      'JWT-based user management (more reliable for production)',
